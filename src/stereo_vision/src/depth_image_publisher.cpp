...
{
  ros::init(argc, argv, "stereo_depth_image");
  ros::NodeHandle nh;

  ros::Subscriber left_image_sub = nh.subscribe("left/image_raw", 1, leftImageCallback);
  ros::Subscriber right_image_sub = nh.subscribe("right/image_raw", 1, rightImageCallback);
